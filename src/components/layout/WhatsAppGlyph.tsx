/**
 * WhatsApp glyph, drawn as a single monochrome path so it inherits the
 * surrounding colour. Rendered white on navy — the brand green is deliberately
 * not used as a fill (docs/03 §4, Q-17 option A).
 */
